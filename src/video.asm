...
; Sends whole lines [first, first+count) with one ESC r bulk write. The
; terminal addresses graphics RAM from the top-left of the given Cartesian
; point, so y = 251 - first and the byte count is 64 * count.
_video_flush_rows:
        ld a,h
        or a
        ret z
